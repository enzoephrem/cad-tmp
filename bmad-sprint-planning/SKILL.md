...
# Step 1: Parse Feature files and extract all work items

- Features from `features.md`
- User Stories from `features.md`
- Implementation Tickets from `{implementation_artifacts}/tickets/`

**ID Conversion Rules:**
- Feature: `feature-1`
- User Story: `1-1-user-auth`
- Ticket: `1-1-1-backend-setup`
...
development_status:
  ...
  1-1-1-fastapi-models: backlog
  1-1-2-nextjs-page: backlog
```
