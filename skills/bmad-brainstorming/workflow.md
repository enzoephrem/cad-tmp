...
```bash
python3 {project-root}/_bmad/scripts/resolve_config.py --project-root {project-root} --key core
```

And resolve:

- `core.project_name`, `core.output_folder`, `core.user_name`
- `core.communication_language`, `core.document_output_language`, `core.user_skill_level`
